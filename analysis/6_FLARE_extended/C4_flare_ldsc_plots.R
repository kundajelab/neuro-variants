...
g=ggplot(df.all2, aes(x = thres, y = Enrichment, color = context, group = context)) +
  ...
  ggpubr::theme_pubr();g
f.out = "/Users/amarderstein/Library/Mobile Documents/com~apple~CloudDocs/Documents/Research/chrombpnet_variant_effects/output/ldsc/plots/flare_ldsc.pdf"
pdf(f.out,width=5,height=4.4)
print(g)
dev.off()

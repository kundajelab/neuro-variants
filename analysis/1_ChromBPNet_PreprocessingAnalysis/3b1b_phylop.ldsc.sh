...
fileName=ldsc.filtered.variants.hg38.tsv
f=$dir/$fileName
...
variant=/oak/stanford/groups/smontgom/amarder/chrombpnet_variant_effects/output/data/variant_lists/ldsc.filtered.variants.hg38.bed
...
variant2=/oak/stanford/groups/smontgom/amarder/chrombpnet_variant_effects/output/data/variant_lists/ldsc.filtered.variants.hg38.chr$chrnum.bed
outfile=/oak/stanford/groups/smontgom/amarder/chrombpnet_variant_effects/output/data/variant_lists/ldsc.filtered.variants.hg38.chr$chrnum.phylop.bed
outfile2=/oak/stanford/groups/smontgom/amarder/chrombpnet_variant_effects/output/data/variant_lists/ldsc.filtered.variants.hg38.chr$chrnum.missing.phylop.bed
...
outfile2=/oak/stanford/groups/smontgom/amarder/chrombpnet_variant_effects/output/data/variant_lists/ldsc.filtered.variants.hg38.chrALL.phylop.bed

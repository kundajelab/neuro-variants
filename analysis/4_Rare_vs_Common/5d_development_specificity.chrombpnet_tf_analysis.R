...
# f = "/oak/stanford/groups/akundaje/projects/neuro-variants/variant_motif_matrices/rare/K562_bias/leiden_96/alpha_0.8/domcke_2020/domcke_2020.fetal_brain.Excitatory_neurons.tsv"
# fb = fread(f,data.table = F,stringsAsFactors = F)
# f = "/oak/stanford/groups/akundaje/projects/neuro-variants/variant_motif_matrices/rare/K562_bias/leiden_96/alpha_0.8/corces_2020/corces_2020.Cluster1.tsv"
# ab = fread(f,data.table = F,stringsAsFactors = F)
f = "/oak/stanford/groups/akundaje/projects/neuro-variants/variant_motif_matrices/rare/K562_bias/all_data_all_patterns/leiden_96/alpha_0.8/domcke_2020/domcke_2020.fetal_brain.Excitatory_neurons.tsv"
fb = fread(f,data.table = F,stringsAsFactors = F)
f = "/oak/stanford/groups/akundaje/projects/neuro-variants/variant_motif_matrices/rare/K562_bias/all_data_all_patterns/leiden_96/alpha_0.8/corces_2020/corces_2020.Cluster1.tsv"
ab = fread(f,data.table = F,stringsAsFactors = F)
...
subset(res.df,tf_adult_specific_ab > 0.04 | tf_fetal_specific_fb > 0.04)

tmp = subset(res.df,tf_adult_specific_ab > 0.04 | tf_fetal_specific_fb > 0.04)

...
score_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/variant_scores/common/ameen_2022/K562_bias
merged_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/merged_variant_scores/common/ameen_2022/K562_bias
summary_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/variant_summary/common/ameen_2022/K562_bias
...
annotated_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/variant_annotations/common/ameen_2022/K562_bias
log_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/logs/variant_annotations/common/ameen_2022/K562_bias
...
for clust in $score_dir/*; do
    ...
    if [[ $expected_lines -eq $observed_lines ]]; then
        [[ -f $annotated_file ]] || \
        sbatch -J $cluster.common -t $time -c $cpus --mem=$mem \

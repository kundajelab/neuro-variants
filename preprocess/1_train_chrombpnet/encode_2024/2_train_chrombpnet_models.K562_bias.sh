...
model_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/chrombpnet_models/encode_2024/${bias_name}_bias
log_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/logs/chrombpnet_models/encode_2024/${bias_name}_bias

...
variants=/oak/stanford/groups/akundaje/projects/neuro-variants/variant_lists/shap_variants.common.model_inputs.hg38.tsv
model_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/chrombpnet_models/domcke_2020/K562_bias
shap_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/variant_shap/common/K562_bias/domcke_2020
log_dir=/oak/stanford/groups/akundaje/projects/neuro-variants/logs/variant_shap/common/K562_bias/domcke_2020
...
for cluster in domcke_2020.fetal_brain.Inhibitory_neurons domcke_2020.fetal_brain.Excitatory_neurons domcke_2020.fetal_brain.Astrocytes domcke_2020.fetal_heart.Myeloid_cells domcke_2020.fetal_heart.Smooth_muscle_cells domcke_2020.fetal_heart.Cardiomyocytes domcke_2020.fetal_heart.Endocardial_cells domcke_2020.fetal_heart.Vascular_endothelial_cells domcke_2020.fetal_heart.Stromal_cells; do
    ...
    for fld in {0..4}; do
        ...
        shap_output_file=$shap_dir/$cluster/$fold/$cluster.$fold.common.shap.variant_shap.counts.h5
        ...
        sbatch -J $cluster.$fold.common.shap.variant_scores -t $time -c $cpus --mem=$mem \
            ...
            $jobscript $scoring_script \
                ...
                -o $shap_dir/$cluster/$fold/$cluster.$fold.common.shap \
                -t 0 \
                -sc chrombpnet

        [[ -f $shap_output_file ]] || \
        sbatch -J $cluster.$fold.common.shap.variant_shap -t $time -c $cpus --mem=$mem \
            -p $partitions --gpus 1 --requeue \
